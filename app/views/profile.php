		...
		<div id="wrapper">
			...
			<header class="clearfix">
				...
				<section id="user">
					...
					<?php if (isset($basic)) { ?>
						<!--<h5 id="score">10k</h5>-->
						<h4><a href="<?php echo "/u:" . $basic['username']; ?>" alt="<?php echo he(idx($basic, 'first_name')); ?> on EatBass"> &#8227; <?php echo he(idx($basic, 'first_name')); ?></a></h4>
